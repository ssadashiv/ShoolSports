 ...
 */
public class Sport_swimFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sport_swim, container, false);
        initView(view);
        initdown();
        return view;
    }
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                stepService.registerCallback(new UpdateUiCallBack() {
                    ...
                    public void updateUi(int stepCount) {
                        UtilsImp.spput("sports3",stepCount);
    ...
    private void initView(View view) {
        ...
        mTvStart.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (mTvStart.getText().equals("结束爬山")) {
                    mTvStart.setBackgroundResource(R.drawable.greed_shaperyuan);
                    mTvIsSupport.setText("长按按钮即可开始爬山");
                    mTvStart.setText("开始爬山");
                    Toast.makeText(getActivity(), "您这次爬山已结束,棒棒哒~", Toast.LENGTH_SHORT).show();
                    kaiguan =false;
                    inittime(false);

                }else {
                    mTvIsSupport.setText("长按按钮即可结束爬山");

                    mTvStart.setBackgroundResource(R.drawable.reed_shaperyuan);
                    mTvStart.setText("结束爬山");
                    Toast.makeText(getActivity(), "您这次爬山已开启，加油呀~", Toast.LENGTH_SHORT).show();
                    initservice();
                    inittime(true);
